    ...
    <header class="MOD_HEADER1">
      <div data-layout="_r">
        <div data-layout="al16 de10" class="MOD_HEADER1_Title">
          <h1 class="MOD_HEADER1_TextLogo" id="syluna_title">syluna</h1>
        ...
        <div data-layout="al16 de6" class="MOD_HEADER1_Details">
          <p class="MOD_HEADER1_Phone">
            <a href="/common/login/openLogin.do">signin  </a>
            <a href="/common/login/openLogin.do">login</a>
          </p>
          <!-- Search -->
      ...
      <div data-layout="_r" class="nopadding">
        <nav class="MOD_MENU_Nav">
          ...
          <ul class="AP_Menu_List">
            <li>
              <a href="/board/openBoardList.do" data-theme="_bgp">board</a>
            </li>
            <li>
